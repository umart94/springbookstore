...
import com.umartariq.utility.MailConstructor;
import com.umartariq.utility.SecurityUtility;
import com.umartariq.utility.USConstants;
...
public class HomeController {
	...
	public String resetPassword(HttpServletRequest request, @ModelAttribute("email") String userEmail, Model model) {
		...
		model.addAttribute("resetPasswordEmailSent", "true");
	...
	public String updateCreditCard(
		...
		//the same user that is currently logged in must edit the credit card.
		//if the id does not match we will return a bad request page. because this is a security issue.
